...
type PatientUseCase interface {
	GetPatientByID(ctx context.Context, id int64) (*Patient, error) // Takes an ID and returns a Patient object
	DeletePatientByID(ctx context.Context, id int64) (int64, error) // Deletes a Patient by ID
	UpdatePatientByID(ctx context.Context, id int64, patient *Patient) (int64, error)
	InsertPatient(ctx context.Context, patient *Patient) (int64, error) // Creates a new patient and inserts in database
